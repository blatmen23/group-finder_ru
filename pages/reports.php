...
<!doctype html>
<html lang="ru">
<p?php $title="GF: Движение студентов КНИТУ-КАИ" ; require_once __DIR__ . "/../components/head.php" ; ?>
                ...
                <main id="moving-parent_1">
                    <div class="block-space">
                        <div class="manual__main">
                            ...
                            <p>На этой странице можно найти ежедневные отчеты о движении студентов КНИТУ-КАИ. Каждый
                                отчет содержит обновления, произошедшие за последние сутки.</p>
                            <p>Записи ведутся с <?= $db_manager->get_report_table_create_date("d.m.Y") ?> года, и на
                                данный
